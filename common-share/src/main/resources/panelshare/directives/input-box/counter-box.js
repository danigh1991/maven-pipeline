...
angular.module('emixApp.directives').directive('counterBox', ['$timeout', '$rootScope', function ($timeout, $rootScope) {
    ...
    return {
        ...
        templateUrl: '/panelshare/directives/input-box/counter-box-template.html' + $rootScope.version,
        replace: true,
        link: function(scope, element, attrs) {
             ...
             */
            scope.readonly = (angular.isUndefined(attrs.editable));
            ...
            scope.id = (angular.isUndefined(attrs.id) ? 'counterbx' : attrs.id);
            scope.label = (angular.isUndefined(attrs.label) ? 'label' : attrs.label);
            scope.size = (angular.isUndefined(attrs.size) ? '' : attrs.size);//sm
