...
(function(angular) {
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                scope.changeTimeValue = function(variable, value) {
                    ...
                    var _timeCopy = {};
                    _timeCopy.hour = scope.time.hour;
                    _timeCopy.minute = scope.time.minute;
    ...
    var ADMdtpDirective = function(ADMdtp, ADMdtpConvertor, ADMdtpFactory, constants, $compile, $timeout, $rootScope) {
            ...
            link: function(scope, element, attrs, ctrls) {
                ...
                scope.openCalendar = function() {
                    ...
                    $timeout(function() {
                        ...
                        //MehdiB
                        //var isRightToLeft = !$('body').hasClass('mbdltr');
                        if (_totalSize.width > window.innerWidth)// || isRightToLeft)
    ...
    return angular.module('ADM-dateTimePicker', [])
        ...
        .directive('admDtp', ['ADMdtp', 'ADMdtpConvertor', 'ADMdtpFactory', 'constants', '$compile', '$timeout', '$rootScope', ADMdtpDirective])
