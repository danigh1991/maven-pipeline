                ...
                return {
                    ...
                    link : function (scope, elm, attrs, controller) {
                        ...
                        eventsWatcher.onAdded = function (event) {
                            if (calendar && calendar.fullCalendar) {
                                //calendar.fullCalendar('renderEvent', event, !!event.stick);Mehdib
                                calendar.fullCalendar('addEvent', event, !!event.stick);
                            }
                        };
                        ...
                        eventsWatcher.onRemoved = function (event) {
                            if (calendar && calendar.fullCalendar) {
                                ...
                                calendar.fullCalendar('removeAllEvents', event._id);
                            }
                        };
