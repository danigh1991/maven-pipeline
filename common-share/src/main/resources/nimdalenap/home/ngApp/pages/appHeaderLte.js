...
angular.module('emixApp.controllers').controller('appHeaderLte', ['$scope', '$rootScope', 'httpServices', '$window', '$location', 'sharedInfo', '$translate', '$cookies', function ($scope, $rootScope, httpServices, $window, $location, sharedInfo, $translate, $cookies) {
    'use strict';
