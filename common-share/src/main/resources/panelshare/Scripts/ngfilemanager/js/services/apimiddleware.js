(function (angular) {
    ...
    angular.module('FileManagerApp').service('apiMiddleware', ['$window', 'fileManagerConfig', 'apiHandler',
        function ($window, fileManagerConfig, ApiHandler) {
            ...
            ApiMiddleware.prototype.editImage = function (files, path) {
                if (!$window.FormData) {
                    throw new Error('Unsupported browser version');
                }
                ...
                return this.apiHandler.editImage(fileManagerConfig.editImage, destination, files);
            };
            ...
            //MehdiB
            ApiMiddleware.prototype.getBase64 = function (item) {
                var itemPath = this.getFilePath(item);
                var url = this.apiHandler.getUrl(fileManagerConfig.downloadFileUrl, itemPath);
                return this.getBase64FromImageUrl(url);                
            };
            ApiMiddleware.prototype.getBase64FromImageUrl = function (url) {
                //var img = new Image();
                ...
                //    alert('e');
                //}
                return this.apiHandler.downloadImage(url);
