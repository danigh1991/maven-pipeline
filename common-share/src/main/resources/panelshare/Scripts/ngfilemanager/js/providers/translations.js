(function (angular) {
    ...
    angular.module('FileManagerApp').config(['$translateProvider', function ($translateProvider) {
        ...
        /*$translateProvider.storagePrefix('locale');
        $translateProvider.storageKey('Lang');*/
        $translateProvider.storageKey(siteConfig.langCookieName);
        ...
        $translateProvider.translations('fa', {
            ...
            upload_image_from_url: 'آپلود تصویر از آدرس',
        });
