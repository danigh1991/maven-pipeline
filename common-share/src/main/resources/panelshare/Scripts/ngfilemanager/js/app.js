(function(window, angular) {
    ...
    angular.element(window.document).on('click', function() {
        ...
        angular.element('div[id="context-menu"]').hide();
    });
    ...
    angular.element(window.document).on('contextmenu', '.main-navigation .table-files tr.item-list:has("td"), .item-list', function(e) {
        ...
        /*var bodyMenu = angular.element('body>#context-menu');
        if(bodyMenu.length > 0) bodyMenu.remove();*/
        //var menu = angular.element('div[id="context-menu"]');
