...
CKEDITOR.dialog.add( 'image2', function( editor ) {
	...
	var regexGetSizeOrEmpty = /(^\s*(\d+)(px)?\s*$)|^$/i,
        ...
        leftToRightStyle = 'text-align:left !important;direction:ltr !important;',
		...
		contents: [
			{
				...
				elements: [
                    ...
                    //Mehdib
                    {
                        ...
                        validate: editor.config.image2_titleRequired === true ? CKEDITOR.dialog.validate.notEmpty( lang.titleMissing ) : null
                    },
                    //Mehdib
                   {
						type: 'hbox',
