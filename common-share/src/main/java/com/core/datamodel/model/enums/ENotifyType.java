...
public enum ENotifyType {
    MOBILE_EMAIL(0l,"eNotifyType.mobile_email"),
    MOBILE(1l,"eNotifyType.mobile"),
    EMAIL(2l,"eNotifyType.email");
    ...
    private ENotifyType(Long id, String caption) {
        this.id = id;
    ...
    public static ENotifyType valueOf(Long id) {
        ENotifyType[] var1 = values();
        int var2 = var1.length;

        for(int var3 = 0; var3 < var2; ++var3) {
            ENotifyType eNotifyType = var1[var3];
    ...
    public static  Map<Long,String> getAllAsMap() {
        Map<Long, String> notifyTypes = new HashMap<>();
        ENotifyType[] eNotifyTypes = ENotifyType.values();
    ...
    public static List<TypeWrapper> getAllAsObjectWrapper() {
        ...
        int len = eNotifyTypes.length;
        for (int var3 = 0; var3 < len; ++var3) {
            typeWrappers.add(ENotifyType.asObjectWrapper(eNotifyTypes[var3]));
        }
        return typeWrappers;
    }

    public static TypeWrapper asObjectWrapper(ENotifyType eNotifyType) {
