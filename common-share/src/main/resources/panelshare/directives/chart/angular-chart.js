(function (factory) {
  ...
  //Chart.defaults.multiTooltipTemplate = '<%if (datasetLabel){%><%=datasetLabel%>: <%}%><%= value %>';
  //Chart.defaults.plugins.tooltips.mode = 'label';
  ...
  if (useExcanvas) Chart.defaults.animation = false;

  return angular.module('emixApp.directives')
