...
(function () {
	CKEDITOR.plugins.add('youtube', {
		lang: [ 'fa', 'en', 'bg', 'pt', 'pt-br', 'ja', 'hu', 'it', 'fr', 'tr', 'ru', 'de', 'ar', 'nl', 'pl', 'vi', 'zh', 'el', 'he', 'es', 'nb', 'nn', 'fi', 'et', 'sk', 'cs', 'ko', 'eu', 'uk'],
				...
				return {
					...
					onOk: function()
					{
						...
						if (this.getContentElement('youtubePlugin', 'txtEmbed').isEnabled()) {
						    //MehdiB
                            content = '<div class="video-wrapper" style="position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden">';
							content += this.getValueOf('youtubePlugin', 'txtEmbed').match(/<iframe(.*)<\/iframe\>/g).toString().replace('<iframe ', '<iframe style="position:absolute;top:0;left:0;width:100%;height:100%" ');
                            content += '</div>';
							//MehdiB
						}
						else {
							...
							if (this.getContentElement('youtubePlugin', 'chkOlderCode').getValue() === true) {
								...
								url += 'hl=' + (this.getParentEditor().config.language ? this.getParentEditor().config.language : 'fa') + '&amp;version=3';
