(function (angular) {
    ...
    angular.module('FileManagerApp').service('fileNavigator', [
        'apiMiddleware', 'fileManagerConfig', 'item', '$translate', function (ApiMiddleware, fileManagerConfig, Item, $translate) {
            ...
            FileNavigator.prototype.getBasePath = function () {
                //MehdiB
                var path = (sessionStorage.getItem('fmanager-burl') || fileManagerConfig.basePath || '').replace(/^\//, '');
            ...
            FileNavigator.prototype.deferredHandler = function (data, deferred, code, defaultMsg) {
                ...
                if (!this.error && data.result && data.result.error) {
                    this.error = $translate.instant(data.result.error);
                }
                if (!this.error && data.error) {
                    this.error = $translate.instant(data.error.message);
                }
